...
# Page styling
st.set_page_config(page_title="Password Strength Checker by M_Tahir", page_icon="🌘", layout="centered")
...
<style>
    ...
    .stButton button { width: 50%; background-color: #5CAF60; color: blue; font-size: 18px; }
